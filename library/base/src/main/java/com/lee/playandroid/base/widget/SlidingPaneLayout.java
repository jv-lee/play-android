package com.lee.playandroid.base.widget;
...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    final ArrayList<SlidingPaneLayout.DisableLayerRunnable> mPostedRunnables = new ArrayList<>();
    ...
    /**
     * No-op stubs for {@link SlidingPaneLayout.PanelSlideListener}. If you only want to implement a subset
    ...
    public SlidingPaneLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        mDragHelper = ViewDragHelper.create(this, 0.5f, new SlidingPaneLayout.DragHelperCallback());
    ...
    protected void onDetachedFromWindow() {
        ...
        for (int i = 0, count = mPostedRunnables.size(); i < count; i++) {
            final SlidingPaneLayout.DisableLayerRunnable dlr = mPostedRunnables.get(i);
            dlr.run();
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            final View child = getChildAt(i);
            final SlidingPaneLayout.LayoutParams lp = (SlidingPaneLayout.LayoutParams) child.getLayoutParams();
            ...
            if (lp.width == SlidingPaneLayout.LayoutParams.WRAP_CONTENT) {
                childWidthSpec = MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin,
                        MeasureSpec.AT_MOST);
            } else if (lp.width == SlidingPaneLayout.LayoutParams.MATCH_PARENT) {
                childWidthSpec = MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin,
                        MeasureSpec.EXACTLY);
            } else {
            ...
            int childHeightSpec;
            if (lp.height == SlidingPaneLayout.LayoutParams.WRAP_CONTENT) {
                childHeightSpec = MeasureSpec.makeMeasureSpec(maxLayoutHeight, MeasureSpec.AT_MOST);
            } else if (lp.height == SlidingPaneLayout.LayoutParams.MATCH_PARENT) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mFirstLayout) {
            if (mCanSlide) {
                ...
                if (((SlidingPaneLayout.LayoutParams) mSlideableView.getLayoutParams()).dimWhenOffset) {
    ...
    void onPanelDragged(int newLeft) {
        ...
        final boolean isLayoutRtl = isLayoutRtlSupport();
        final SlidingPaneLayout.LayoutParams lp = (SlidingPaneLayout.LayoutParams) mSlideableView.getLayoutParams();
    ...
    private void dimChildView(View v, float mag, int fadeColor) {
        final SlidingPaneLayout.LayoutParams lp = (SlidingPaneLayout.LayoutParams) v.getLayoutParams();
        ...
        if (mag > 0 && fadeColor != 0) {
            ...
            final SlidingPaneLayout.DisableLayerRunnable dlr = new SlidingPaneLayout.DisableLayerRunnable(v);
    ...
    void invalidateChildRegion(View v) {
        if (Build.VERSION.SDK_INT >= 17) {
            ViewCompat.setLayerPaint(v, ((SlidingPaneLayout.LayoutParams) v.getLayoutParams()).dimPaint);
            return;
        }
    ...
    private void parallaxOtherViews(float slideOffset) {
        final boolean isLayoutRtl = isLayoutRtlSupport();
        final SlidingPaneLayout.LayoutParams slideLp = (SlidingPaneLayout.LayoutParams) mSlideableView.getLayoutParams();
    ...
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MarginLayoutParams
                ? new SlidingPaneLayout.LayoutParams((MarginLayoutParams) p)
                : new SlidingPaneLayout.LayoutParams(p);
    }
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            final SlidingPaneLayout.LayoutParams lp = (SlidingPaneLayout.LayoutParams) releasedChild.getLayoutParams();
