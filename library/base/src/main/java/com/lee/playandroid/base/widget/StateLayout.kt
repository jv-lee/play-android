...
class StateLayout @JvmOverloads constructor(
    ...
    private fun readAttrs(context: Context, attrs: AttributeSet?) {
        ...
        mLoadingView =
            inflaterView(R.styleable.StateLayout_layout_loading, R.layout.layout_state_loading)
        mErrorView =
            inflaterView(R.styleable.StateLayout_layout_error, R.layout.layout_state_error)
        mEmptyView =
            inflaterView(R.styleable.StateLayout_layout_empty, R.layout.layout_state_empty)
        mNetworkView =
            inflaterView(R.styleable.StateLayout_layout_network, R.layout.layout_state_network)
